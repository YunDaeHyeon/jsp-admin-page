        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link active">
             ...
             <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="ecc_mgt.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p> 추가 / 수정 / 삭제 </p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="ecc_mgt_admin.jsp" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p> [Admin] ECC 관리 </p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">ECC 영역 관리 - 추가 / 수정 / 삭제 </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
              <li class="breadcrumb-item active">ECC</li>
              <li class="breadcrumb-item active">ECC Management</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <form method="post" action="ecc_mgt_add_Action.jsp">
		<div class="row">
			<div class="col-md-6">
			<div class = "card card-primary">
				<div class = "card-header">
					<h3 class="card-title">ECC 추가</h3>
			...
			<div class="card-body">
              <div class="form-group">
                <label for="test_run_year">시행년도</label>
                <input type="text" id="test_run_year" name="test_run_year" placeholder="시행년도" class="form-control">
              </div>
              <div class="form-group">
                <label for="test_top_type">대영역</label>
                <select id="test_top_type" name="test_top_type" class="form-control custom-select">
                 <option>안녕하세요</option>
                </select>
              </div>
              <div class="form-group">
                <label for="test_middle_type">중영역</label>
                <input type="text" id="test_middle_type" name="test_middle_type" placeholder="중영역" class="form-control">
              </div>
              <div class="form-group">
                <label for="test_bottom_type">소영역</label>
                <input type="text" id="test_bottom_type" name="test_bottom_type" placeholder="소영역" class="form-control">
              </div>
            </div>
			</div>
			</div>
		<div class="col-md-6">
			...
			<div class="card-body">
              <div class="form-group">
                <label for="test_run_year">No</label>
                <input type="text" id="test_run_year" name="test_run_year" class="form-control">
              </div>
              <div class="form-group">
                <label for="test_top_type">기술설명</label>
                <input type="text" id="test_top_type" name="test_top_type" class="form-control">
              </div>
            </div>
			</div>
		</div>
