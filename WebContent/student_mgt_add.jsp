...
<body> <!-- 사이드바 Open / Close  class="sidebar-collapse" -->
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Student Management Add</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <form method = "post" action="student_mgt_add_Action.jsp">
		<div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">학생 추가</h3>
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" id="studentName" name="studentName" placeholder="학생 이름" class="form-control">
              </div>
              <div class="form-group">
                <label for="studentImage">학생 사진</label>
                <input type="text" id="studentImage" name="studentImage" class="form-control">
              </div>
              <div class="form-group">
                <label for="studentClass">학년/반</label>
                <input type="text" id="studentClass" name="studentClass" placeholder="학년/반" class="form-control">
              </div>
              <div class="form-group">
                <label for="studentDate">생년월일</label>
                <input type="text" id="studentDate" name="studentDate" placeholder="생년월일" class="form-control">
              </div>
              <div class="form-group">
                <label for="studentDisable">장애 분류</label>
                <select id="studentDisable" name="studentDisable" class="form-control custom-select">
                  <option selected disabled>장애 분류</option>
                  <option>시각장애 </option>
                  <option>청각장애 </option>
                  <option>지체장애 </option>
                  <option>지적장애 </option>
          ...
          <div class="card card-secondary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" id="studentPhoneNumber" name="studentPhoneNumber" placeholder="전화번호" class="form-control">
              </div>
              <div class="form-group">
                <label for="studentClassInfo">입학년도</label>
                <input type="text" id="studentClassInfo" name="studentClassInfo" placeholder="입학년도" class="form-control">
              </div>
            </div>
            <!-- /.card-body -->
          </div>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" value="추가" class="btn btn-success float-right">
        </div>
      </div>   
    </form>
