          ...
          <li class="nav-item">
            <a href="#" class="nav-link active">
             ...
             <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="ecc_mgt_admin.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p> [Admin] ECC 관리 </p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">ECC 영역 관리 - [Admin] </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
              <li class="breadcrumb-item active">ECC</li>
              <li class="breadcrumb-item active">[Admin] ECC Management</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
		...
		<div class="col-md-6">
			<div class = "card card-primary">
				<div class = "card-header">
					<h3 class="card-title">[Admin] ECC 추가</h3>
			...
			<div class="card-body">
              <div class="form-group">
                <label for="form_year">시행년도</label>
                <select id="form_year" name="form_year" class="form-control">
                	<option selected>2021</option>
                	<option>2020</option>
                </select>
              </div>
              <div class="form-group">
                <label for="form_top_type">대영역</label>
                <input type="text" id="form_top_type" name="form_top_type" placeholder="대영역" class="form-control">
              </div>
              <div class="form-group">
                <label for="form_middle_type">중영역</label>
                <input type="text" id="form_middle_type" name="form_middle_type" placeholder="중영역" class="form-control">
              </div>
            </div>
			</div>
		</div>
	...
	<div class="row">
        <div class="col-6">
          <a href="ecc_mgt.jsp" class="btn btn-secondary">어드민 페이지 벗어나기</a>
